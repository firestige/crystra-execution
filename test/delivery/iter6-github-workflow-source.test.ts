...
function fixture(overrides: Readonly<{
  ...
  const provenance = body({
    ...
    source: { repository: overrides.provenanceRepository ?? "firestige/crystra-workflow-package", revision: "a".repeat(40) },
  ...
  return new GitHubWorkflowPackageSource({
    kind: "github", repository: "firestige/crystra-workflow-package",
